...
int main(int argc, char *argv[])
{
	...
	skepu::Vector<float> r2(size), e(1);
	...
	auto test1 = skepu::MapTuple<2>(test1_f);
	test1.setBackend(spec);
	test1(r1, r2, v1, v2, e, 10);
	std::cout << "Test 1: r1 = " << r1 << "\nr2 = " << r2 << "\n\n";
	
	auto test2 = skepu::MapTuple<0>(test2_f);
	...
	auto test_single = skepu::MapTuple<2>(test_single_f);
	...
	auto test_row_1 = skepu::MapTuple<0>(test_row_1_f<int>);
	test_row_1.setBackend(spec);
	test_row_1(r1, m, v1);
	std::cout << "Test Row 1: r1 = " << r1 << "\n\n";
	
	
	auto test_row_2 = skepu::MapTuple<2>(test_row_2_f<int>);
