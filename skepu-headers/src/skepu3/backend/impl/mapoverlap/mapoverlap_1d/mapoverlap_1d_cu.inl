/*! \file mapoverlap_1d_cu.inl
 *  \brief Contains the definitions of CUDA specific member functions for the MapOverlap1D skeleton.
 */
...
namespace skepu
{
	namespace backend
	{
		...
		::mapOverlapMultiThread_CU_Col(size_t numDevices, size_t _numcols, Parity p, pack_indices<OI...>, pack_indices<EI...>, pack_indices<AI...>, pack_indices<CI...>, CallArgs&&... args)
		{
			...
			//		get<AI>(std::forward<CallArgs>(args)...).getParent().size(), i, MapOverlapFunc::anyAccessMode[AI-InArity-OutArity])...);
