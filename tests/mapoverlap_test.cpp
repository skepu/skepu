...
int main(int argc, char* argv[]) {
	...
	skepu2::Vector<int> seqRes(NUM_ELEMENTS);
	skepu2::Vector<int> hybridRes(NUM_ELEMENTS);
	skepu2::Matrix<int> seqMatRes(NUM_ELEMENTS, NUM_ELEMENTS);
	skepu2::Matrix<int> hybridMatRes(NUM_ELEMENTS, NUM_ELEMENTS);
	skepu2::Matrix<int> hybridMatRes2(NUM_ELEMENTS, NUM_ELEMENTS);
	
	skeleton.setOverlap(2);
	skeleton.setPad(42);
	skeleton.setEdgeMode(skepu2::Edge::Pad);
	...
	skeleton.setOverlapMode(skepu2::Overlap::RowWise);
	skeleton.setBackend(spec1);
	...
	skeleton.setOverlapMode(skepu2::Overlap::ColWise);
	skeleton.setBackend(spec1);
	skeleton(seqMatRes, inMat);
